 ...
 */
abstract class ProcessImageTask(private val src: String, private val output: String, private val inSampleSize: Int, private val rotation: Int) : AsyncTask<Void, Void, String>() {
